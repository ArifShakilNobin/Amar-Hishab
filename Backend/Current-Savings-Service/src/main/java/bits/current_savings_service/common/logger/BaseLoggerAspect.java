package bits.current_savings_service.common.logger;

import bits.current_savings_service.common.annotations.SensitiveData;
...
public abstract class BaseLoggerAspect {
    ...
    @Pointcut("@within(bits.current_savings_service.common.annotations.NoLogging)")
